        ...
        <section id="skills" className="py-15  sm:mt-0 lg:mt-15 font-mono ">
            <div className="text-2xl text-white min-h-screen w-full   ">
              ...
              <motion.div
               ...
               <div className="h-auto w-full px-3 py-1 bg-blue-500/20 border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300  flex gap-4 rounded-lg items-center justify-center"> <FaHtml5 size={40} className="text-orange-700 text-center"/><div className="text-center">HTML</div></div>
                <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center"><FaCss3 size={40} className="text-blue-600"/> <div className="text-center">CSS</div></div>
                <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center"><FaJs size={40} className="text-yellow-400"/><div className="text-center">JS</div></div>
                <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center" ><FaReact size={40} className="text-blue-300"/><div className="text-center">React</div></div>
               ...
               <div className="h-auto w-full px-3 py-1 bg-blue-500/20 border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300  flex gap-4 rounded-lg items-center justify-center"> <FaNodeJs size={40} className="text-green-600 text-center"/><div className="text-center">Node.js</div></div>
                <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center"><RiNextjsFill size={40} className="text-white"/> <div className="text-center">Next.js</div></div>
                <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center"><DiMongodb size={40} className="text-green-400"/><div className="text-center">MongoDB</div></div>
             ...
             >
               ...
               <div className="px-10 py-5 gap-8 flex justify-start items-start sm:items-center flex-col">
               <div className="h-auto w-full px-3 py-1 bg-blue-500/20 border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300  flex gap-4 rounded-lg items-center justify-center"> <FaJs size={40} className="text-yellow-400 text-center"/><div className="text-center">JS</div></div>
                <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center"><SiCplusplus size={40} className="text-blue-300"/> <div className="text-center">C++</div></div>
                 <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center"><FaPython size={40} className="text-blue-500"/> <div className="text-center">Python</div></div>
                                 <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center"><SiNetlify size={40} className="text-red-300"/> <div className="text-center">Netlify</div></div>         
                 <div className="h-auto w-full border-2 border-blue-500/20 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.7)] transition-all ease-in-out duration-300 px-3 py-2 bg-blue-500/20 flex gap-4 rounded-lg items-center justify-center"><FaGithub size={40} className="text-grey-300"/> <div className="text-center">Github</div></div>
               </div>
               </div>
             </motion.div>
