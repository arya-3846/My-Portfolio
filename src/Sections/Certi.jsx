          ...
          <div className="text-2xl text-white w-full">
             ...
             <div className="flex justify-center items-center flex-wrap gap-10">
              ...
              <div className="px-10 flex gap-5 justify-center flex-wrap ">
                <div className="h-80 w-70 md:w-90 shrink-0 bg-blue-700/20 rounded-lg px-5 py-7 border-2 border-blue-500/20 hover:border-blue-700 transition-all ease-in-out duration-300"> 
              ...
              <div className="px-10 flex gap-5 justify-center flex-wrap ">
                <div className="h-80 w-70 md:w-90 shrink-0 bg-blue-700/20 rounded-lg px-5 py-7 border-t-2 border-blue-500"> 
                ...
                <div className="font-medium text-blue-500 ">Data Analytics Simulation</div>
                 <div className="text-sm py-2 ">Gained hands-on experience in data analysis, data visualization, and business intelligence. Worked with real-world datasets to identify trends, generate insights, and present findings through effective visualizations and reports.</div> 
